...
module.exports = [
  {
    ...
    languageOptions: {
      ...
      globals: {
        ...
        FileReader: "readonly",
        // Caricato da CDN solo nella pagina dell'orologio (export ZIP):
        // il codice ne verifica sempre la presenza prima di usarlo.
        JSZip: "readonly",
        // Simboli globali condivisi tra i file di uno stesso tool: sono
        // <script> classici, quindi si vedono a vicenda tramite window.
        LSI18n: "readonly"
      }
    },
    rules: {
